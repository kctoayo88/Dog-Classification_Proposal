...
csv_logger = CSVLogger('Xception_training.csv')
...
train_generator=train_datagen.flow_from_directory('C:\\Users\\user\\Desktop\\Proposal\\picture_train', 
                                            target_size=(img_height, img_width), 
                                            batch_size=n_batch_size,
                                            shuffle=True)

test_generator = test_datagen.flow_from_directory('C:\\Users\\user\\Desktop\\Proposal\\picture_test',
                                                  target_size=(img_height, img_width),
                                                  batch_size=n_batch_size)
...
model.fit_generator(train_generator,
                    ...
                    epochs = n_epochs,
                    validation_steps = n_steps_per_epoch - 400,
